...
startButton.addEventListener("click", () => {});
    ...
    function updateTime() {
        ...
        // Pad the minutes and seconds to always display two digits
        let paddedMins = mins.toString().padStart(2, '0');
        let paddedSecs = secs.toString().padStart(2, '0');
    
        // Update the text content of the timeDisplay element
        timeDisplay.textContent = `${paddedMins}:${paddedSecs}`;
    }
